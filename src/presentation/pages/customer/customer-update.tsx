...
const CustomerUpdate: React.FC<Props> = ({ saveCustomer, getCustomer, validation }: Props) => {
    ...
    const [customer, setCustomer] = useState<SaveCustomer.Model>({ _id: '', name: '', description: '' });
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>, fields: SaveCustomer.Model): Promise<void> => {
